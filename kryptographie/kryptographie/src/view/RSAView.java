...
public class RSAView extends JFrame {
	...
	private RSAController controler;
	...
	public RSAView() {
		...
		controler = new RSAController(this);
		...
		decrypt.add(btn_decrypt_calculate2);
				...
				JPanel panel_signaturCreate = new JPanel();
				...
				txt_sign_text = new JTextArea();
				txt_sign_text.setLineWrap(true);
				scrollPane_22.setViewportView(txt_sign_text);
				
				JLabel lblTextToSign = new JLabel("Text to sign");
				...
				txt_sign_d = new JTextArea();
				txt_sign_d.setLineWrap(true);
				scrollPane_23.setViewportView(txt_sign_d);
				
				JScrollPane scrollPane_24 = new JScrollPane();
				scrollPane_24.setBounds(360, 146, 337, 87);
				panel_signaturCreate.add(scrollPane_24);
				
				txt_sign_n = new JTextArea();
				txt_sign_n.setLineWrap(true);
				scrollPane_24.setViewportView(txt_sign_n);
				
				btn_sign_sign = new JButton("Sign");
				btn_sign_sign.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						controler.btn_sign_sign(e);
					}
				});
				btn_sign_sign.setBounds(541, 244, 156, 41);
				panel_signaturCreate.add(btn_sign_sign);
				
				JScrollPane scrollPane_25 = new JScrollPane();
				scrollPane_25.setBounds(10, 296, 688, 165);
				panel_signaturCreate.add(scrollPane_25);
				
				txt_sign_signature = new JTextArea();
				txt_sign_signature.setLineWrap(true);
				scrollPane_25.setViewportView(txt_sign_signature);
				
				JLabel lblNewLabel_10 = new JLabel("Hashfunction");
				lblNewLabel_10.setBounds(358, 258, 63, 14);
				panel_signaturCreate.add(lblNewLabel_10);
				
				cb_sign_hash = new JComboBox<String>();
				cb_sign_hash.addItem("SHA1");
				cb_sign_hash.addItemListener(new ItemListener() {
					public void itemStateChanged(ItemEvent e) {
						controler.cb_sign_hash_action();
					}
				});
				cb_sign_hash.setBounds(435, 254, 102, 20);
				panel_signaturCreate.add(cb_sign_hash);
				
				JLabel lblSignature = new JLabel("Signature");
				lblSignature.setBounds(10, 277, 118, 16);
				panel_signaturCreate.add(lblSignature);
		
				JPanel panel_signaturVerification = new JPanel();
				...
				txt_verifySig_signature = new JTextArea();
				txt_verifySig_signature.setLineWrap(true);
				scrollPane_17.setViewportView(txt_verifySig_signature);
				...
				txt_verifySig_e = new JTextArea();
				txt_verifySig_e.setLineWrap(true);
				scrollPane_19.setViewportView(txt_verifySig_e);
				...
				txt_verifySig_n = new JTextArea();
				txt_verifySig_n.setLineWrap(true);
				scrollPane_20.setViewportView(txt_verifySig_n);
				
				cb_verifySig_hashFunction = new JComboBox<String>();
				cb_verifySig_hashFunction.addItem("SHA1");
				cb_verifySig_hashFunction.addItemListener(new ItemListener() {
					public void itemStateChanged(ItemEvent e) {
					}
				});
				cb_verifySig_hashFunction.setBounds(435, 254, 102, 20);
				panel_signaturVerification.add(cb_verifySig_hashFunction);
				
				JLabel label_3 = new JLabel("Hashfunction");
				label_3.setBounds(358, 258, 63, 14);
				panel_signaturVerification.add(label_3);
				
				btn_verifySig_verify = new JButton("Verify");
				btn_verifySig_verify.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						controler.btn_verifySig_verify(e);
					}
				});
				btn_verifySig_verify.setBounds(541, 244, 156, 41);
				panel_signaturVerification.add(btn_verifySig_verify);
				...
				JLabel lblChiffrat = new JLabel("Signed chiffrat");
				...
				txt_verifySig_signedChiffrat = new JTextArea();
				scrollPane_18.setViewportView(txt_verifySig_signedChiffrat);
				
				JLabel lblHashsignedChiffrat = new JLabel("hash(signedChiffrat) == signature^e (mod n)");
				lblHashsignedChiffrat.setBounds(360, 302, 228, 20);
				panel_signaturVerification.add(lblHashsignedChiffrat);
				
				lbl_verifySig_result = new JLabel("");
				lbl_verifySig_result.setBounds(598, 305, 104, 14);
				panel_signaturVerification.add(lbl_verifySig_result);
		...
		btn_primes_calculate.setBounds(10, 436, 692, 25);
		panel.add(btn_primes_calculate);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(90, 83, 612, 342);
		...
		txt_euklid_numberA.setBounds(78, 11, 624, 20);
		...
		txt_euklid_numberB.setBounds(78, 42, 624, 20);
		...
		txt_euklid_result.setBounds(78, 73, 624, 20);
		...
		btn_euklid_calc.setBounds(10, 101, 692, 23);
		...
		textField.setBounds(80, 10, 622, 22);
		panel_powerFast.add(textField);
		textField.setColumns(10);

		textField_1 = new JTextField();
		textField_1.setBounds(80, 45, 622, 22);
		...
		textField_2.setBounds(80, 80, 622, 22);
		panel_powerFast.add(textField_2);

		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(80, 115, 622, 22);
		...
		btnNewButton.setBounds(12, 148, 690, 25);
	...
	public JLabel getLbl_verifySig_result() {
		return lbl_verifySig_result;
	}

	public void setLbl_verifySig_result(JLabel lbl_verifySig_result) {
		this.lbl_verifySig_result = lbl_verifySig_result;
	}

	public JTextArea getTxt_verifySig_signature() {
		return txt_verifySig_signature;
	}

	public void setTxt_verifySig_signature(JTextArea txt_verifySig_signature) {
		this.txt_verifySig_signature = txt_verifySig_signature;
	}

	public JTextArea getTxt_verifySig_e() {
		return txt_verifySig_e;
	}

	public void setTxt_verifySig_e(JTextArea txt_verifySig_e) {
		this.txt_verifySig_e = txt_verifySig_e;
	}

	public JTextArea getTxt_verifySig_n() {
		return txt_verifySig_n;
	}

	public void setTxt_verifySig_n(JTextArea txt_verifySig_n) {
		this.txt_verifySig_n = txt_verifySig_n;
	}

	public JComboBox<String> getCb_verifySig_hashFunction() {
		return cb_verifySig_hashFunction;
	}

	public void setCb_verifySig_hashFunction(JComboBox<String> cb_verifySig_hashFunction) {
		this.cb_verifySig_hashFunction = cb_verifySig_hashFunction;
	}

	public JButton getBtn_verifySig_verify() {
		return btn_verifySig_verify;
	}

	public void setBtn_verifySig_verify(JButton btn_verifySig_verify) {
		this.btn_verifySig_verify = btn_verifySig_verify;
	}

	public JTextArea getTxt_verifySig_signedChiffrat() {
		return txt_verifySig_signedChiffrat;
	}

	public void setTxt_verifySig_signedChiffrat(JTextArea txt_verifySig_signedChiffrat) {
		this.txt_verifySig_signedChiffrat = txt_verifySig_signedChiffrat;
	}

	public JTextArea getTxt_sign_text() {
		return txt_sign_text;
	}

	public void setTxt_sign_text(JTextArea txt_sign_text) {
	...
	public void setTxt_sign_n(JTextArea txt_sign_n) {
		this.txt_sign_n = txt_sign_n;
	}

	public JButton getBtn_sign_sign() {
		return btn_sign_sign;
	}

	public void setBtn_sign_sign(JButton btn_sign_sign) {
		this.btn_sign_sign = btn_sign_sign;
	}

	public JTextArea getTxt_sign_signature() {
		return txt_sign_signature;
	}

	public void setTxt_sign_signature(JTextArea txt_sign_signature) {
	...
	public void setCb_sign_hash(JComboBox<String> cb_sign_hash) {
	...
	public void setTxt_sign_d(JTextArea txt_sign_d) {
	...
	private void setAllComboBoxes() {
		List<String> availableCharsets = Encoding.getAvailableCharsetNames();
